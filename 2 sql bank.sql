create database Bankserver1;
	...
	DESCRIBE student;
    UPDATE student SET S_NAME="ABHISHEKJAISWALAASHU" WHERE S_ID=10152;
    UPDATE student SET S_NAME="ABHISHEKJAISWALAASHU";
    DELETE FROM STUDENT ;
    insert into Student value(10551,"aadarsh","aadarsh2030@efggmail.com","854299450187"),(165502,"aaamr","aamr789@trggmail.com","854235976315"),(10553,"jatin","jattgrin942@gmail.com","8576996545662423");
